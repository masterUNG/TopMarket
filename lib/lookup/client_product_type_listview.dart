...
class ClientProductTypeListView extends StatefulWidget {
//String itemID, String itemName
  ClientProductTypeListView(
...
//-- ตัวแปรลูก
  ...
  @override
  _ClientProductTypeListViewState createState() =>
      _ClientProductTypeListViewState();
}

class _ClientProductTypeListViewState extends State<ClientProductTypeListView> {
  Timer? timer;
        ...
        child: Card(
          child: Row(
            children: [
              ...
              //       "/asset/get_image_product_type.php?client=" +
  ...
  Future<List<MasterModel>> getMasterModelList() async {
    String url = MyConstant.apiDomainName.toString() +
        "/lookup/product_type.php?client=" +
        MyConstant.currentClientID.toString() +
        "&group=" +
        widget.productGroupID.toString() +
        "&key=" +
