...
class ClientWorkPointMonth extends StatefulWidget {
  const ClientWorkPointMonth({Key? key}) : super(key: key);

  @override
  _ClientWorkPointMonthState createState() => _ClientWorkPointMonthState();
}

class _ClientWorkPointMonthState extends State<ClientWorkPointMonth> {
  ...
  Future<SumWorkPointModel> getSumWorkPointModel() async {
    ...
    String urlWorkPoint = MyConstant.apiDomainName.toString() +
        "/sum_workpoint_month.php?id=" +
        MyConstant.currentClientID.toString();

    print("WorkPoint Month => "+urlWorkPoint);
